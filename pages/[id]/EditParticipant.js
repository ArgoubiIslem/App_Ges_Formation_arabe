...
const EditParticipant = ({ participant, setUpdateParticipant }) => {
  ...
  const [form, setForm] = useState({
    ...
    salle: participant?.salle,
    dateDebut: participant?.dateDebut,
  });
  ...
  return (
    <>
      <div
        onClick={() => setUpdateParticipant(false)}
        ...
        <div className="w-full max-w-4xl lg:w-5/6">
          <div className="leading-loose">
            {isLoading ? (
              ...
              <form
                className="m-4  rounded bg-white p-20 shadow-xl grid grid-cols-2 grid-rows-2 gap-2"
...
EditParticipant.getInitialProps = async ({ query: { id } }) => {
