            ...
            {isLoading ? (
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <Select className="block w-full px-4 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300 focus:border-blue-300">
                    {cyclesData
                      ? cyclesData.map(function (cycle, i) {
                          return (
                            <option key={i} value={cycle.nom}>
                              {cycle.nom}
                            </option>
                          );
                        })
