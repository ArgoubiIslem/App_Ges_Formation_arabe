...
function FormateurCard({ formateur }) {
  ...
  const deleteFormateur = async () => {
    try {
      await fetch(`http://localhost:3000/api/formateurs/${formateur?._id}`, {
        method: 'Delete',
      });
              ...
              <td className="py-3 px-6 text-center">
                <div className="item-center flex justify-center">
                  ...
                  <button
                    onClick={() =>
                      !updateFormateur
                        ? setUpdateFormateur(true) || setFormateurId(formateur)
                        : setUpdateFormateur(false)
                    }
                  >
